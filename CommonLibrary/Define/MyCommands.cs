...
namespace iFactory.CommonLibrary
{
    public static class MyCommands
    {
        ...
        public static RoutedCommand Cancel = new RoutedCommand("Cancel", typeof(MyCommands),
        ...
        public static RoutedCommand Start = new RoutedCommand("Start", typeof(MyCommands),
          new InputGestureCollection { new KeyGesture(Key.S, ModifierKeys.Control) });

        public static RoutedCommand Stop = new RoutedCommand("Stop", typeof(MyCommands),
           new InputGestureCollection { new KeyGesture(Key.E, ModifierKeys.Control) });

        public static RoutedCommand Restart = new RoutedCommand("Restart", typeof(MyCommands),
          new InputGestureCollection { new KeyGesture(Key.E, ModifierKeys.Control) });

        public static RoutedCommand DownLoad = new RoutedCommand("DownLoad", typeof(MyCommands),
           new InputGestureCollection { new KeyGesture(Key.F10) });

        public static RoutedCommand Refresh = new RoutedCommand("Refresh", typeof(MyCommands),
